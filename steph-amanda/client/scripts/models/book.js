...
// heroku deployed page goes into URL above
...
(function(module) {
  ...
  // It's being invoked under the apiUrl. Once it is hit under the search and submit event. The callback is the search on title or author.
  ...
  // This method is invoked when the isbn search function is called. This differs because the above is searching by book while this one is looking via the isbn number.
  Book.findOne = isbn =>
